...
import { Home, ArrowUpRight, ArchiveRestore } from "../../../lib/icons";
...
export default function CaruggiELanterne() {
  ...
  "url":"${CARUGGI_EVENT_DATA.url}"
      ...
      <div className="cel-page">
        ...
        <div className="bg-accent/10 border-b border-accent/20 px-4 py-3 text-center flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-sm font-medium text-accent-foreground z-50 relative">
          <div className="flex items-center gap-2">
            <ArchiveRestore size={16} />
            <span>Stai visualizzando l'archivio dell'edizione 2026.</span>
          </div>
          <a href={ROUTES.caruggiELanterne} className="underline decoration-accent/50 underline-offset-4 hover:decoration-accent transition-all font-bold">
            Scopri le novità per la prossima edizione &rarr;
          </a>
        </div>

        <a href={ROUTES.home} className="cel-site-hint" style={{ top: "4rem" }}>
