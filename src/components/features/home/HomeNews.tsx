...
const HomeNews = ({ featuredNews, fadeUp }: HomeNewsProps) => {
  ...
  return (
    <section className="bg-background py-10 lg:py-24">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-stretch">
              ...
              <div className="flex flex-1 flex-col p-5 md:p-6 lg:p-8">
                ...
                <p className="mb-6 flex-1 text-sm leading-relaxed text-muted-foreground line-clamp-3 md:text-base md:line-clamp-2">
